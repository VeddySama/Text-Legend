...
object DropsData {
    val sets: List<DropSet> = listOf(
        DropSet(
            ...
            items = listOf(
                DropItem("armor_taishan", "圣战宝甲", listOf(
                    DropEntry("赤月恶魔", "6%"), DropEntry("魔龙教主", "6%"), DropEntry("世界BOSS", "6%"), DropEntry("沙巴克BOSS", "8%")
                )),
                DropItem("helm_holy", "圣战头盔(套)", listOf(
                    DropEntry("赤月恶魔", "2%"), DropEntry("魔龙教主", "2%"), DropEntry("世界BOSS", "2%"), DropEntry("沙巴克BOSS", "3%")
                )),
                ...
                DropItem("ring_holy", "圣战戒指(套)", listOf(
                    DropEntry("黄泉教主", "4%"), DropEntry("赤月恶魔", "6%"), DropEntry("世界BOSS", "4%"), DropEntry("沙巴克BOSS", "6%")
                )),
                DropItem("necklace_soldier", "圣战项链(套)", listOf(
                    DropEntry("赤月恶魔", "8%"), DropEntry("世界BOSS", "4%"), DropEntry("沙巴克BOSS", "6%")
                )),
                DropItem("bracelet_soldier", "圣战手镯(套)", listOf(
                    DropEntry("赤月恶魔", "4%"), DropEntry("魔龙教主", "4%"), DropEntry("世界BOSS", "4%"), DropEntry("沙巴克BOSS", "6%")
                ))
            )
        ),
        DropSet(
            ...
            items = listOf(
                DropItem("armor_mage", "法神披风", listOf(
                    DropEntry("赤月恶魔", "6%"), DropEntry("双头金刚", "8%"), DropEntry("魔龙教主", "6%"), DropEntry("世界BOSS", "6%"), DropEntry("沙巴克BOSS", "8%")
                )),
        ...
        DropSet(
            ...
            items = listOf(
                ...
                DropItem("ring_tianzun", "天尊戒指(套)", listOf(
                    DropEntry("虹魔教主", "6%"), DropEntry("赤月恶魔", "6%"), DropEntry("双头血魔", "6%"), DropEntry("世界BOSS", "4%"), DropEntry("沙巴克BOSS", "6%")
                )),
        ...
        DropSet(
            ...
            items = listOf(
                DropItem("armor_thunder", "雷霆战甲", listOf(
                    DropEntry("魔龙教主", "2%"), DropEntry("世界BOSS", "1.5%"), DropEntry("沙巴克BOSS", "2%")
                )),
                DropItem("helm_wargod", "战神头盔(套)", listOf(
                    DropEntry("魔龙教主", "0.5%"), DropEntry("世界BOSS", "0.8%"), DropEntry("沙巴克BOSS", "1%")
                )),
                ...
                DropItem("ring_wargod", "战神戒指(套)", listOf(
                    DropEntry("魔龙教主", "0.3%"), DropEntry("世界BOSS", "0.5%"), DropEntry("沙巴克BOSS", "0.6%")
                )),
        ...
        DropSet(
            ...
            name = "洛奇套装",
            items = listOf(
                DropItem("sword_rochie", "洛奇王者之刃", listOf(DropEntry("世界BOSS", "0.5%"))),
                DropItem("staff_rochie", "洛奇王者权杖", listOf(DropEntry("世界BOSS", "0.5%"))),
                DropItem("sword_rochie_tao", "洛奇王者之剑", listOf(DropEntry("世界BOSS", "0.5%"))),
                DropItem("armor_rochie_war", "洛奇战甲", listOf(DropEntry("世界BOSS", "0.5%"))),
                DropItem("armor_rochie_mage", "洛奇法袍", listOf(DropEntry("世界BOSS", "0.5%"))),
                DropItem("armor_rochie_tao", "洛奇道袍", listOf(DropEntry("世界BOSS", "0.5%"))),
                DropItem("helm_rochie_war", "洛奇头盔(战士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("helm_rochie_mage", "洛奇头盔(法师)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("helm_rochie_tao", "洛奇头盔(道士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("boots_rochie_war", "洛奇靴子(战士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("boots_rochie_mage", "洛奇靴子(法师)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("boots_rochie_tao", "洛奇靴子(道士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("belt_rochie_war", "洛奇腰带(战士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("belt_rochie_mage", "洛奇腰带(法师)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("belt_rochie_tao", "洛奇腰带(道士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("ring_rochie_war", "洛奇戒指(战士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("ring_rochie_mage", "洛奇戒指(法师)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("ring_rochie_tao", "洛奇戒指(道士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("bracelet_rochie_war", "洛奇手镯(战士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("bracelet_rochie_mage", "洛奇手镯(法师)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("bracelet_rochie_tao", "洛奇手镯(道士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("necklace_rochie_war", "洛奇项链(战士)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("necklace_rochie_mage", "洛奇项链(法师)", listOf(DropEntry("世界BOSS", "0.3%"))),
                DropItem("necklace_rochie_tao", "洛奇项链(道士)", listOf(DropEntry("世界BOSS", "0.3%")))
            )
        ),
        DropSet(
            id = "skillbook",
            ...
            items = listOf(
                ...
                DropItem("book_war_earth_spike", "技能书: 彻地钉", listOf(DropEntry("世界BOSS", "3%"))),
                ...
                DropItem("book_mage_thunderstorm", "技能书: 雷霆万钧", listOf(DropEntry("世界BOSS", "3%"))),
                ...
                DropItem("book_tao_white_tiger", "技能书: 召唤白虎", listOf(DropEntry("世界BOSS", "3%")))
            )
        ),
        DropSet(
            id = "special",
            ...
            items = listOf(
                DropItem("ring_dodge", "躲避戒指", listOf(
                    DropEntry("牛魔王", "0.8%"), DropEntry("魔龙教主", "0.5%"), DropEntry("暗之沃玛教主", "0.5%"), DropEntry("暗之祖玛教主", "0.5%"), DropEntry("暗之赤月恶魔", "0.5%"), DropEntry("暗之虹魔教主", "0.5%"), DropEntry("暗之骷髅精灵", "0.5%"), DropEntry("世界BOSS", "1.5%"), DropEntry("沙巴克BOSS", "2%")
                )),
                DropItem("ring_def", "防御戒指", listOf(
                    DropEntry("祖玛教主", "0.8%"), DropEntry("魔龙教主", "0.5%"), DropEntry("暗之沃玛教主", "0.5%"), DropEntry("暗之祖玛教主", "0.5%"), DropEntry("暗之赤月恶魔", "0.5%"), DropEntry("暗之虹魔教主", "0.5%"), DropEntry("暗之骷髅精灵", "0.5%"), DropEntry("世界BOSS", "1.5%"), DropEntry("沙巴克BOSS", "2%")
                )),
                DropItem("ring_fire", "吸血戒指", listOf(
                    DropEntry("祖玛教主", "0.8%"), DropEntry("魔龙教主", "0.5%"), DropEntry("暗之沃玛教主", "0.5%"), DropEntry("暗之祖玛教主", "0.5%"), DropEntry("暗之赤月恶魔", "0.5%"), DropEntry("暗之虹魔教主", "0.5%"), DropEntry("暗之骷髅精灵", "0.5%"), DropEntry("世界BOSS", "1.5%"), DropEntry("沙巴克BOSS", "2%")
                )),
                DropItem("ring_heal", "治愈戒指", listOf(
                    DropEntry("魔龙教主", "0.5%"), DropEntry("暗之沃玛教主", "0.5%"), DropEntry("暗之祖玛教主", "0.5%"), DropEntry("暗之赤月恶魔", "0.5%"), DropEntry("暗之虹魔教主", "0.5%"), DropEntry("暗之骷髅精灵", "0.5%"), DropEntry("世界BOSS", "1.5%"), DropEntry("沙巴克BOSS", "2%")
                )),
                DropItem("ring_magic", "麻痹戒指", listOf(
                    DropEntry("魔龙教主", "0.5%"), DropEntry("牛魔王", "0.5%"), DropEntry("暗之沃玛教主", "0.5%"), DropEntry("暗之祖玛教主", "0.5%"), DropEntry("暗之赤月恶魔", "0.5%"), DropEntry("暗之虹魔教主", "0.5%"), DropEntry("暗之骷髅精灵", "0.5%"), DropEntry("世界BOSS", "1.5%"), DropEntry("沙巴克BOSS", "2%")
                )),
                DropItem("ring_teleport", "弱化戒指", listOf(
                    DropEntry("魔龙教主", "0.5%"), DropEntry("牛魔王", "0.6%"), DropEntry("暗之沃玛教主", "0.5%"), DropEntry("暗之祖玛教主", "0.5%"), DropEntry("暗之赤月恶魔", "0.5%"), DropEntry("暗之虹魔教主", "0.5%"), DropEntry("暗之骷髅精灵", "0.5%"), DropEntry("世界BOSS", "1.5%"), DropEntry("沙巴克BOSS", "2%")
                )),
                ...
                DropItem("ring_recall", "记忆戒指", listOf(
                    DropEntry("魔龙教主", "0.3%"), DropEntry("暗之沃玛教主", "0.3%"), DropEntry("暗之祖玛教主", "0.3%"), DropEntry("暗之赤月恶魔", "0.3%"), DropEntry("暗之虹魔教主", "0.3%"), DropEntry("暗之骷髅精灵", "0.3%"), DropEntry("世界BOSS", "0.8%"), DropEntry("沙巴克BOSS", "1.5%")
                ))
            )
        )
    )
